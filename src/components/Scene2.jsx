      ...
      <Html fullscreen>
        <div className="w-full h-full relative z-[99999] pointer-events-auto">
          ...
          <div className="cta_btn flex justify-center items-center h-full">
            <button onClick={() => setFormOpen(true)} className={`bg-gradient-to-r cursor-pointer  border ${showScene1 ? "border-black text-black hover:bg-white" : "border-white text-white hover:bg-black"}  uppercase bg-transparent  text-sm sm:text-lg mb-20 md:mb-48 tracking-[2px] py-[8px] px-[30px] transition duration-300 ease-in-out transform hover:scale-105`}
            > Enquire Now</button>
          </div>
          ...
          <div className="absolute left-0 md:left-10 right-0 md:right-10 bottom-7 sm:bottom-5  text-white flex justify-center md:justify-between items-center gap-5 md:gap-0 ">
            <div className="qr flex gap-3">
              <img src={`${prefix}images/qrcode.png`} alt="qr" className="w-10 h-auto " />
              <span className="mt-[7px] text-[12px] hidden sm:block">RERA NUMBER: UPRERAPRJ510056/09/2025</span>
            </div>
          <a href="tel:7777079770"> <div className="call text-white cursor-pointer bg-transparent hover:bg-gray-400 border-white border w-10 h-10 rounded-full flex justify-center items-center p-1">
              <IoCall size={20} />
            </div></a>
          </div>
